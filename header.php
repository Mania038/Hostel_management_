...
.sidebar-brand{font-family:var(--fd);font-size:1.05rem;font-weight:800;padding:.5rem .7rem .9rem;background:var(--ag);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;display:block;}
